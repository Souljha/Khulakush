const mockProducts = [
  ...
  {
    name: 'Hemp Wick', description: 'Some prefer hemp wicks for a cleaner, butane-free flame that can enhance the flavor.', price: 80.00, imageUrl: '/images/HempWick.png', category: "Accessories", stock: 30
  },
  {
