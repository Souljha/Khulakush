...
import { CATEGORIES_ORDER, KHULA_KUSH_GREEN, KHULA_KUSH_SURFACE_LIGHT, KHULA_KUSH_TEXT_HEADING, KHULA_KUSH_TEXT_MUTED, KHULA_KUSH_TEXT_ON_GREEN } from '../constants';
            ...
            {group.title === FoodType.BREAKFAST_ADD_ONS ? (
              <ul className="list-disc pl-5 space-y-2">
                {group.items.map(product => {
                  ...
                  return (
                    <li key={product.id} className="text-gray-700 text-lg flex justify-between items-center pb-2 mb-2 border-b border-gray-200 last:border-b-0 last:pb-0 last:mb-0">
